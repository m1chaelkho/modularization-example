    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0){
            HStack(alignment: .center, spacing: 10){
                Image(postData.profileImage, bundle: .IGHome)
                    .resizable()
                    .scaledToFill()
            ...
            if !postData.isVideo {
                ZStack(alignment: .center){
                    Image(postData.postImage, bundle: .IGHome)
                        .resizable()
                        .scaledToFill()
                    ...
                    Image("white-heart", bundle: .IGHome)
                        .resizable()
                        .scaledToFill()
                ...
                ZStack(alignment: .center){
                    ...
                    if Bundle.IGHome.url(forResource: postData.videoUrl, withExtension: "mp4") != nil {
                        PlayerView(url: Bundle.IGHome.url(forResource: postData.videoUrl, withExtension: "mp4")!, isMute: $isMute)
                ...
                .overlay(
                    Button(action:{
                        ...
                        ZStack{
                            ...
                            Image(isMute ? "mute" : "sound", bundle: .IGHome)
                                .resizable()
            ...
            HStack(alignment: .center, spacing: 10){
                Button(action:{
                    ...
                    Image(postData.isLiked ? "like-selected" : "like", bundle: .IGHome)
                        .resizable()
                        .scaledToFill()
                        .frame(width: 30, height: 30, alignment: .center)
                }
                ...
                Button(action:{
                    ...
                    Image(postData.isSaved ? "save-selected" : "save", bundle: .IGHome)
                        .resizable()
                        .scaledToFill()
                        .frame(width: 30, height: 30, alignment: .center)
                }
